...
def start_scheduler():
    ...
    for hour, minute in [(7,25),(7,35),(9,30),(11,0),(13,30),(14,30),(20,0),(20,15)]:
    ...
    scheduler.start()
    add_log("Scheduler ready - 07:25 07:35 09:30 11:00 13:30 14:30 20:00 20:15 IST (Mon-Fri) + self-ping every 10 min")
    return scheduler
