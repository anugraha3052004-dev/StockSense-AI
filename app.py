...
NIFTY500_SYMBOLS = [
    ...
    "FEDERALBNK.NS","IDFCFIRSTB.NS","BANDHANBNK.NS","CHOLAFIN.NS",
    "SHRIRAMFIN.NS","MUTHOOTFIN.NS","MANAPPURAM.NS","MPHASIS.NS",
    "COFORGE.NS","PERSISTENT.NS","LTTS.NS","KPIT.NS","DIXON.NS",
    "TATAELXSI.NS","ZOMATO.NS","NAUKRI.NS","INDIAMART.NS","AFFLE.NS",
    "HAL.NS","BEL.NS","RVNL.NS","IRFC.NS","DLF.NS",
    "GODREJPROP.NS","PRESTIGE.NS","APOLLO.NS","FORTIS.NS","LALPATHLAB.NS",
    # Nifty Midcap 150
    "OBEROIRLTY.NS","BRIGADE.NS","SOBHA.NS","PHOENIXLTD.NS","KOLTEPATIL.NS",
    "SUNTECK.NS","MAHLIFE.NS","LODHA.NS","SIGNATURE.NS","GREENPANEL.NS",
    "CENTURYPLY.NS","ASTRAL.NS","PRINCEPIPE.NS","FINOLEX.NS","SUPREME.NS",
    "NILKAMAL.NS","ACTION.NS","BATAINDIA.NS","RELAXO.NS","METROBRAND.NS",
    "CAMPUS.NS","VIPIND.NS","SAFARI.NS","TRENT.NS","DMART.NS",
    "VMART.NS","NYKAA.NS","PAYTM.NS","POLICYBZR.NS","CARTRADE.NS",
    "EASEMYTRIP.NS","IXIGO.NS","HUDCO.NS","RECLTD.NS","PFC.NS",
    "NHPC.NS","SJVN.NS","CESC.NS","TORNTPOWER.NS","TATAPOWER.NS",
    "ADANIGREEN.NS","ADANIPOWER.NS","JSWENERGY.NS","GREENKO.NS","KAYNES.NS",
    "SYRMA.NS","AMBER.NS","MAXHEALTH.NS","ASTER.NS","NARAYANA.NS",
    "METROPOLIS.NS","THYROCARE.NS","ALKEM.NS","TORNTPHARM.NS","IPCALAB.NS",
    "AJANTPHARM.NS","GRANULES.NS","LAURUSLABS.NS","NATCOPHARM.NS","GLENMARK.NS",
    "BIOCON.NS","AUROPHARMA.NS","SUNPHARMA.NS","ABBOTINDIA.NS","PFIZER.NS",
    "BLUEDART.NS","MAHLOG.NS","GATI.NS","EXIDEIND.NS","AMARARAJA.NS",
    "SUNDRMFAST.NS","SCHAEFFLER.NS","SKFINDIA.NS","NMDC.NS","SAIL.NS",
    "NATIONALUM.NS","MOIL.NS","WELCORP.NS","HINDCOPPER.NS","RATNAMANI.NS",
    "KARURVYSYA.NS","DCBBANK.NS","RBLBANK.NS","UJJIVANSFB.NS","EQUITASBNK.NS",
    "CSBBANK.NS","SOUTHBANK.NS","IOB.NS","MAHABANK.NS","CENTRALBK.NS",
    "UCOBANK.NS","INDIANB.NS","BANKINDIA.NS","ANGELONE.NS","ICICIPRULI.NS",
    "HDFCAMC.NS","NIPPONLIFE.NS","UTIAMC.NS","CAMS.NS","KFINTECH.NS",
    "BSE.NS","MCX.NS","CDSL.NS","IIFL.NS","AAVAS.NS",
    "HOMEFIRST.NS","APTUS.NS","M&MFIN.NS","BAJAJHLDNG.NS","CHOLAHLDNG.NS",
    # Nifty Smallcap (liquid ones)
    "RAILTEL.NS","NBCC.NS","RITES.NS","BEML.NS","MAZAGON.NS",
    "COCHINSHIP.NS","GRSE.NS","GARDENREACH.NS","MTAR.NS","PARAS.NS",
    "AIAENG.NS","THERMAX.NS","CUMMINSIND.NS","BHEL.NS","SIEMENS.NS",
    "ABB.NS","HONAUT.NS","VOLTAS.NS","BLUESTARCO.NS","KALPATPOWR.NS",
    "POWERMECH.NS","KEC.NS","JYOTISTRUC.NS","INOXWIND.NS","SUZLON.NS",
    "ORIENTELEC.NS","POLYCAB.NS","KEI.NS","FINOLEX.NS","CABLEIND.NS",
    "ZENSARTECH.NS","RATEGAIN.NS","TANLA.NS","MASTEK.NS","SONATSOFTW.NS",
    "NAZARA.NS","JUSTDIAL.NS","TATACOMM.NS","HFCL.NS","TEJAS.NS",
    "IDEA.NS","TTML.NS","ROUTE.NS","INDIACEM.NS","DALMIACEM.NS",
    "JKCEMENT.NS","RAMCOCEM.NS","HEIDELBERG.NS","BIRLACORPN.NS","PRISM.NS",
    "KANSAINER.NS","AKZONOBEL.NS","PIDILITIND.NS","GNFC.NS","DEEPAKNI.NS",
    "ATUL.NS","NAVINFLUOR.NS","FLUOROCHEM.NS","SRF.NS","AARTIIND.NS",
    "VINATIORGA.NS","GALAXYSURF.NS","BALRAMCHIN.NS","RENUKA.NS","TRIVENI.NS",
    "KRBL.NS","LTFOODS.NS","AVANTIFEED.NS","WATERBASE.NS","APEX.NS",
    "SWANENERGY.NS","JPPOWER.NS","RPOWER.NS","TRIL.NS","INDIGRID.NS",
    "PNBHOUSING.NS","LICHOUSING.NS","GRUH.NS","CANFINHOME.NS","REPCO.NS",
    "INDHOUSING.NS","AHLUCONT.NS","NESCO.NS","WONDERLA.NS","MAHINDCIE.NS",
    "TIINDIA.NS","SUNDARMFIN.NS","CHOLAFIN.NS","MGFL.NS","SPANDANA.NS",
    "CREDITACC.NS","UJJIVAN.NS","AROHAN.NS","FUSION.NS","SURYODAY.NS",
]
...
def check_nifty_trend():
    try:
        ...
        add_log(f"  Nifty check failed: {e}")
...
def phase2_analyze(candidates, market):
    ...
    for c in candidates:
        ...
        if earn["skip"]:
            ...
            continue
        ind = td_indicators(sym) if TD_KEY else None
        if ind is None:
            try:
...
def run_pipeline():
    ...
    if now_ist.weekday() >= 5: add_log("Weekend - skipped"); return
    state["running"] = True
...
def start_scheduler():
    ...
    for hour, minute in [(9,30),(11,0),(13,30),(14,30)]:
        scheduler.add_job(run_pipeline, CronTrigger(hour=hour, minute=minute, day_of_week="mon-fri", timezone=IST))
    scheduler.start()
    add_log("Scheduler ready - 09:30 11:00 13:30 14:30 IST (Mon-Fri)")
    return scheduler
