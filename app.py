...
NIFTY500_SYMBOLS = [
    ...
    "SUPREMEIND.NS","NILKAMAL.NS","ACTION.NS","BATAINDIA.NS","RELAXO.NS",
    ...
    "AMBER.NS","MAXHEALTH.NS","ASTER.NS","NARAYANA.NS","METROPOLIS.NS",
    ...
    "GATI.NS","EXIDEIND.NS","AMARARAJA.NS","SUNDRMFAST.NS","SCHAEFFLER.NS",
    ...
    "GULFOILLUB.NS","TIDE.NS","SOTL.NS","BASF.NS","FINEORG.NS",
    "NOCIL.NS","TATACHEM.NS","GSFC.NS","CHAMBAL.NS","COROMANDEL.NS",
    "PIIND.NS","DHANUKA.NS","RALLIS.NS","BAYER.NS","SUMICHEM.NS",
    "INSECTICID.NS","EXCEL.NS","HERANBA.NS","DHANI.NS","TVSHLTD.NS",
    "ESCORTS.NS","FORCEMOT.NS","ASHOKLEY.NS","SMLISUZU.NS","TVSMOTOR.NS",
    "BAJAJAUTO.NS","ROYALENF.NS","JMFINANCL.NS",
]
...
def start_scheduler():
    ...
    scheduler.start()
    add_log("Scheduler ready - 09:30 11:00 13:30 14:30 IST (Mon-Fri) + self-ping every 10 min")
    return scheduler
